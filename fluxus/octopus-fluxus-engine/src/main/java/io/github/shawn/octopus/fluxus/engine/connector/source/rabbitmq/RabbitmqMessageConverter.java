...
/** @author zuoyl */
public class RabbitmqMessageConverter implements RowRecordConverter<byte[]> {

  private final List<Schema> schemas;

  public RabbitmqMessageConverter(List<Schema> schemas) {
    this.schemas = schemas;
  }

  @Override
  public SourceRowRecord convert(byte[] message) {
