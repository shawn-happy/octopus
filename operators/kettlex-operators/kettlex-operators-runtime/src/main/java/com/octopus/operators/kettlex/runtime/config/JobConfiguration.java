...
import static com.octopus.operators.kettlex.core.steps.config.ConfigurationTag.TaskConfigurationTag.TASK_DESCRIPTION;
import static com.octopus.operators.kettlex.core.steps.config.ConfigurationTag.TaskConfigurationTag.TASK_ID;
import static com.octopus.operators.kettlex.core.steps.config.ConfigurationTag.TaskConfigurationTag.TASK_NAME;
import static com.octopus.operators.kettlex.core.steps.config.ConfigurationTag.TaskConfigurationTag.TASK_READER_CONFIGS;
import static com.octopus.operators.kettlex.core.steps.config.ConfigurationTag.TaskConfigurationTag.TASK_RUNTIME_CONFIG;
import static com.octopus.operators.kettlex.core.steps.config.ConfigurationTag.TaskConfigurationTag.TASK_TRANSFORMATION_CONFIGS;
import static com.octopus.operators.kettlex.core.steps.config.ConfigurationTag.TaskConfigurationTag.TASK_VERSION;
import static com.octopus.operators.kettlex.core.steps.config.ConfigurationTag.TaskConfigurationTag.TASK_WRITER_CONFIGS;
