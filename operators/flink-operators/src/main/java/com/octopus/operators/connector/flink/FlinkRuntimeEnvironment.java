...
import static com.octopus.operators.connector.flink.FlinkRuntimeEnvironmentConstant.CHECKPOINT_CLEANUP_MODE;
import static com.octopus.operators.connector.flink.FlinkRuntimeEnvironmentConstant.CHECKPOINT_DATA_URI;
import static com.octopus.operators.connector.flink.FlinkRuntimeEnvironmentConstant.CHECKPOINT_MODE;
import static com.octopus.operators.connector.flink.FlinkRuntimeEnvironmentConstant.FAIL_ON_CHECKPOINTING_ERRORS;
import static com.octopus.operators.connector.flink.FlinkRuntimeEnvironmentConstant.MAX_CONCURRENT_CHECKPOINTS;
import static com.octopus.operators.connector.flink.FlinkRuntimeEnvironmentConstant.MIN_PAUSE_BETWEEN_CHECKPOINTS;
import static com.octopus.operators.connector.flink.FlinkRuntimeEnvironmentConstant.TIME_CHARACTERISTIC;
