...
public enum SqlServerFieldType implements FieldType {
  ...
  NTEXT("NTEXT", FieldDescriptor.builder().chName("文本类型").description("TEXT类型，长文本字符串").build()),
  ...
  VARBINARY(
      ...
      FieldDescriptor.builder()
          ...
          .build()),
  IMAGE("IMAGE", FieldDescriptor.builder().chName("图片类型").description("与Char类型相似").build()),
  ;
  ...
  SqlServerFieldType(String dataType, FieldDescriptor fieldDescriptor) {
